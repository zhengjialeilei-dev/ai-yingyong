...
const PINYIN_DICT: { [key: string]: string } = {
  ...
  // 数学相关
  '数': 's', '学': 'x', '算': 's', '角': 'j', '度': 'd', '圆': 'y', '面': 'm',
  '积': 'j', '体': 't', '周': 'z', '长': 'c', '宽': 'k', '高': 'g', '直': 'z',
  '径': 'j', '半': 'b', '平': 'p', '方': 'f', '立': 'l', '三': 's', '四': 's',
  '五': 'w', '六': 'l', '七': 'q', '八': 'b', '九': 'j', '十': 's', '百': 'b',
  '千': 'q', '万': 'w', '亿': 'y', '加': 'j', '减': 'j', '乘': 'c', '除': 'c',
  '等': 'd', '于': 'y', '大': 'd', '小': 'x', '多': 'd', '少': 's', '分': 'f',
  '合': 'h', '整': 'z', '余': 'y', '负': 'f', '正': 'z', '奇': 'q', '偶': 'o',
  '质': 'z', '因': 'y', '倍': 'b', '约': 'y', '公': 'g', '最': 'z', '比': 'b',
  '例': 'l', '率': 'l', '概': 'g', '统': 't', '计': 'j', '扇': 's', '形': 'x',
  '柱': 'z', '锥': 'z', '棱': 'l', '台': 't', '球': 'q', '线': 'x', '段': 'd',
  '射': 's', '点': 'd', '对': 'd', '称': 'c', '轴': 'z', '旋': 'x', '转': 'z',
  '平': 'p', '移': 'y', '浓': 'n', '博': 'b', '士': 's', '异': 'y', '图': 't',
  '表': 'b', '条': 't', '折': 'z', '饼': 'b', '柱': 'z', '象': 'x', '概': 'g',
  '念': 'n', '推': 't', '导': 'd', '演': 'y', '示': 's', '交': 'j', '互': 'h',
  '应': 'y', '用': 'y', '课': 'k', '堂': 't', '教': 'j', '标': 'b', '案': 'a',
  '件': 'j', '资': 'z', '源': 'y', '智': 'z', '流': 'l', '赋': 'f', '能': 'n',
};
